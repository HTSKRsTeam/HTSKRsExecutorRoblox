if _G.HTSKRsLoaded then
	return
end

local HTSKRs = Instance.new("ScreenGui")
...
HTSKRs.Name = "HTSKRs"
HTSKRs.Parent = (game:GetService("CoreGui") or gethui())
HTSKRs.ZIndexBehavior = Enum.ZIndexBehavior.Sibling
_G.HTSKRsLoaded = true
...
execbox.PlaceholderText = "-- Made by Nguyễn Minh Nhật (Discord: discord.gg/Hk4FTJt9sf)"
execbox.Text = ""
...
executeclipboard.Text = "Thi Thi Từ Clipboard"
...
local function QIWXMR_fake_script() -- main.LocalScript 
	...
	print("Chào Mừng, "..game.Players.LocalPlayer.Name.. " Đã Sử Dụng HT SKRs!.")
	...
	local openHTSKRs = screengui.open
...
mainframe.Draggable = true
	...
	click(openHTSKRs, function()
		openHTSKRs.Visible = false
		mainframe.Visible = true
		openHTSKRs.Draggable = true
	end)
	...
	click(searchbutton, function()
		if issearching then
			game.StarterGui:SetCore("SendNotification", {
				Title = "HT SKRs",
				Text = "Một cuộc tìm kiếm hiện đang được tiến hành. Vui lòng đợi Biểu tượng tìm kiếm trở lại bình thường, điều này cho biết quá trình tìm kiếm đã kết thúc.",
				Duration = 1,
			})
			return
		end
			...
			if scriptthing:IsA("Frame") and scriptthing.Name:match("scriptexample") then
				...
				repeat
					...
					if next(gamedata) == nil then
						print("HT SKRs Không Có Kết Quả.")
					else
						for i, v in pairs(gamedata) do
							...
							real.copy.MouseButton1Click:Connect(function()
								real.copy.Text = "Đã Sao Chép"
								wait(0.5)
								real.copy.Text = "Sao Chép"
	...
	RunService.Heartbeat:Connect(function()
		...
		if hour >= 5 and hour < 12 then
			greeting = "Chào Buổi Sáng, " .. plrname .. "!"
		elseif hour >= 12 and hour < 17 then
			greeting = "Chào Buổi Chiều, " .. plrname .. "!"
		elseif hour >= 17 and hour < 21 then
			greeting = "Chúc Ngủ Ngon, " .. plrname .. "!"
		else
	...
	createdlabel.Text = "Được Tạo: "..getcorrectcreationdate
	updatedlabel.Text = "Cập Nhật Lần Cuối: "..getcorrectupdateddate
	local maxplayerslabel = hometab.secondsec.rightside.maxplayers
